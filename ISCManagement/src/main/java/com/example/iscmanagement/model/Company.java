...
public class Company {
	...
	public Company(Long companyId, String companyName, String companyAddress, String companyContactPerson,
			String companyPhone, String companyUrl, EnumStatus companyStatus, List<Student> students) {
		super();
