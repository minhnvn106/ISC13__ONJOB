    ...
    <Fragment>
      ...
      >
        <div className="rounded-t mb-0 px-4 py-3 border-0">
          {/* Table Header định text canh giữa*/}
          <div className="flex flex-wrap items-center">
            
            {/* Header Title Names */}
            <div className="relative w-full px-4 max-w-full flex-grow flex-1">
              {/* Table Title dựa theo light hay dark*/}
              <h3
                className={
              ...
              <i className="fas fa-plus"></i> 
                ...
                <form autoComplete="on" onSubmit={formik.handleSubmit}>
                  <Modal.Body>        
                    ...
                    <Input id="txtStdType" type="text" className="inputClass form-control" label="Loại học viên" labelSize="4" maxLength="100"
                    ...
                    <Input id="txtStdWorkStatus" type="text" className="inputClass form-control" label="Tình trạng" labelSize="4" maxLength="100"
                    ...
                    <Input id="txtStdNote" type="text" className="inputClass form-control" label="Note" labelSize="4" maxLength="100"
